...
const JOBS = [
  { name: 'http-stateless',     slide: 7,  sel: ['.stateless'],         dur: 8,    fig: true },
  { name: 'authn-vs-authz',     slide: 4,  sel: ['.id-scan', '.doors'], dur: 12,   header: true, pad: 8 },
  { name: 'token-timeline',     slide: 13, sel: ['.tl'],                dur: 9,    fig: true },
  { name: 'lifecycle-sequence', slide: 15, sel: null,                   dur: 15.6, scale: 0.55, fps: 6 },
  { name: 'xss-storage',        slide: 14, sel: ['.xss'],               dur: 8,    fig: true },
  { name: 'fetch-wrapper',      slide: 16, sel: ['.icp'],               dur: 5,    fig: true },
  { name: 'silent-refresh',     slide: 17, sel: ['.sr-btn', '#srFig'],  dur: 14 },
  { name: 'auth-store',         slide: 19, sel: ['.sig'],               dur: 6,    fig: true },
  { name: 'route-guard',        slide: 20, sel: ['.guard'],             dur: 10,   fig: true },
];
